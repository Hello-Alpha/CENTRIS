...
parser.add_argument("--src_path", type=str,
                    default="/home/syssec-py/CENTRIS_cxy/repositories", help="所有repository的存储文件夹,建议使用绝对路径")
parser.add_argument("--result_path", type=str,
                    default="/home/syssec-py/CENTRIS_cxy/results", help="repo分析之后文件的存储文件夹,建议使用绝对路径")
...
parser.add_argument("--config", type=str,
                    default="config_test.txt", help="配置文件")
